...
<style>
    ...
    .ai-layout-breadcrumb .ai-layout-breadcrumb-list .ai-layout-breadcrumb-item .router-link-active {
        margin: 0;
        display: block;
    ...
    .ai-layout-breadcrumb .ai-layout-breadcrumb-list .ai-layout-breadcrumb-item span {
        margin-left: 10px;
        margin-right: 10px;
    }
    ...
    .ai-layout-breadcrumb .ai-layout-breadcrumb-list .ai-layout-breadcrumb-item .last-text {
        margin-left: 10px;
    }
</style>
